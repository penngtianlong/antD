...
class AddFeature extends Component{
    ...
    renderSelect=(arr,caditon)=>{
        ...
        switch (caditon) {
            case "classifyName":
                return(
                    <Select style={{ width: 200 }} onChange={this.handleChange.bind(this,caditon)}>
    ...
    submit=()=>{
        ...
        this.$axios.post('http://10.60.12.88:8888/addTraitData',{classifyName,categoryName,sort,status,traitName}).then((data)=>{
            console.log(data)
            if (data.data.code === 1) {
